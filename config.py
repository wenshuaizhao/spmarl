...
def get_config():
    ...
    parser.add_argument("--log_interval", type=int, default=10, help="time duration between contiunous twice log printing.")

    # eval parameters
    parser.add_argument("--use_eval", action='store_true', default=False, help="by default, do not start evaluation. If set`, start evaluation alongside with training.")
    parser.add_argument("--eval_interval", type=int, default=10, help="time duration between contiunous twice evaluation progress.")
    parser.add_argument("--eval_episodes", type=int, default=100, help="number of episodes of a single evaluation.")
    ...
    # add for robust marl experiments
